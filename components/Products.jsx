        ...
        <>
            {portalImage && (
                <Portal handleClosePortal={() => {setPortalImage(null)}}>
                    <div className="portal-content">
                        <img className="img-diplay" src={`med_res/${portalImage}.jpeg`} alt={`${portalImage}-high-res`}/>
                    </div>
                </Portal>
            )}
            <div className="section-container">
                ...
                <div className="planner-content">
                    ...
                    <div className="planner-info">
                        ...
                        <h3><span>$</span>16.91</h3>
                        <p>Step into a realm of fantasy and organization with 
                            our <strong>Medieval Dragon Month Planner</strong>! 
                            This high-resolution PNG asset combines the fierce elegance 
                            of dragons with intricate medieval designs to create a 
                            planner that's not only functional but also a work of art. 
                            Whether you&apos;re jotting down quests, planning battles, 
                            or just scheduling your weekly grocery run, this planner 
                            is your ultimate companion.</p>
                            <ul>
                                <li><strong>Epic Dragon Artwork:</strong> 
                                    Stunning hand-drawn dragon motifs and medieval-inspired 
                                    borders make every month feel legendary.
                                </li>
                                <li><strong>Fully Printable:</strong> 
                                    Designed at ultra-high resolution, it&apos;s perfect 
                                    for printing on any size paper, from A4 to 
            ...
            <div className="sticker-container">
                {stickers.map((sticker, stickerIndex)=> {
                    ...
                    const stickerImgUrl = sticker.name.replaceAll('Sticker.png','').trim().replaceAll(' ','_');
                    return (
                        <div key={stickerIndex} className="sticker-card"> 
                            <button  onClick={()=> {
                                    setPortalImage(stickerImgUrl);
                                }} className="img-button">
                                <img src={`low_res/${stickerImgUrl}.jpeg`} alt={`${stickerName}-low-res`}/>
                            </button>
